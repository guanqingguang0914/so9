...
public class ProtocolBuilder {
    ...
    public static final byte[] CMD_RESPONSE_SET_FACE_TRACK_MODE={(byte)0xA7,(byte)0x0A};

    public static final byte[] CMD_RESPONSE_FACE_TRACKED_FLAG={(byte)0xA7,(byte)0x0B};

    public static final byte[] CMD_RESPONSE_FACE_TRACKED_POS={(byte)0xA7,(byte)0x0C};
