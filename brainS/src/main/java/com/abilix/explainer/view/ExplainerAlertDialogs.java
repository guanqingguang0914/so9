...
public class ExplainerAlertDialogs implements IExplainerAlertDialogs {
    ...
    public static final int ALERTDIALOG_GYRO_CALIBRATION = 12;
    ...
    private AlertDialog mGyroCalibrationAlertDialog;
    ...
    public void showAlertDialog(Context context, int which, String message) {
        ...
        switch (which) {
            ...
            case ALERTDIALOG_DELETE_VIEWPAGE:
                ...
                break;
            case ALERTDIALOG_GYRO_CALIBRATION:
                showGyroCalibrationAlertDialog(context);
                break;
    ...
    public void dismissAlertDialog(int which) {
        switch (which) {
            ...
            case ALERTDIALOG_GRAY_VALUE: //7
                ...
                break;
            case ALERTDIALOG_GYRO_CALIBRATION: //12
                dismisGyroCalibrationAlertDialog();
                break;
    ...
    public void showGrayValueAlertDialog(Context context, String data) {
        ...
        mGrayValueAlertDialog.setCanceledOnTouchOutside(true);
    ...
    @Override
    public void showGyroCalibrationAlertDialog(Context context) {
        if (mGyroCalibrationAlertDialog != null
                && mGyroCalibrationAlertDialog.isShowing()) {
            return;
        }
        mGyroCalibrationAlertDialog = CommonUtils.showNoButtonDialog(
                context,
                context.getResources().getString(R.string.tishi),
                context.getResources().getString(R.string.tips_gyro_calibration),
                false);
        mGyroCalibrationAlertDialog.setCancelable(true);
        mGyroCalibrationAlertDialog.show();
    }

    @Override
    public void dismisGyroCalibrationAlertDialog() {
        if (mGyroCalibrationAlertDialog != null) {
            mGyroCalibrationAlertDialog.dismiss();
            mGyroCalibrationAlertDialog = null;
        }
    }
}
