...
//		return currentTime_2;
    ...
    public static int getButtonDialogBackgroundDrawableResource(){
        ...
        switch (ControlInfo.getMain_robot_type()) {
            ...
            case ExplainerInitiator.ROBOT_TYPE_M:
                ...
                drawableResourceID = R.drawable.m_dialog_bg;
                break;
            //H系列
            case ExplainerInitiator.ROBOT_TYPE_H:
    ...
    public static int getSingleButtonDialogButtonBackgroundDrawableResource(){
        ...
        switch (ControlInfo.getMain_robot_type()) {
            ...
            case ExplainerInitiator.ROBOT_TYPE_M:
                ...
                drawableResourceID = R.drawable.single_button_dialog_button_background_m_12;
                break;
            //H系列
            case ExplainerInitiator.ROBOT_TYPE_H:
    ...
    public static int getTwoButtonDialogButtonBackgroundDrawableResource(int leftOrRignt){
        ...
        switch (ControlInfo.getMain_robot_type()) {
            ...
            case ExplainerInitiator.ROBOT_TYPE_M:
                ...
                drawableResourceID = R.drawable.two_button_dialog_button_background_m_12;
                break;
            //H系列
            case ExplainerInitiator.ROBOT_TYPE_H:
                if(side == right){
    ...
    public static AlertDialog showSingleButtonDialog(Context context, String title, String message, String buttonString, boolean isSystemDialog,
        ...
        ImageView m_divide = (ImageView) window.findViewById(R.id.m_iv_divide);
        ...
        if (ControlInfo.getChild_robot_type() == ExplainerInitiator.ROBOT_TYPE_CU) {
        ...
        if (ControlInfo.getMain_robot_type() == ExplainerInitiator.ROBOT_TYPE_M) {
            ...
            tv_message.setTextColor(Color.BLACK);
            btn.setTextColor(Color.WHITE);
            m_divide.setVisibility(View.VISIBLE);
        }
