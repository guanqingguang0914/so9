...
public abstract class AExplainHelper implements IRobot {
    ...
    public String getString(byte[] buffer, int index) {
        ...
        String string = "";
        try {
            string = new String(nameBytes, "UTF-8");
    ...
    private final static String[] hello_zh = {"hello.mp3", "bye-bye.mp3", "opposition.mp3", "welcome.mp3", "guanzhao.mp3"};
    private final static String[] hello_en = {"hello_en.mp3", "bye-bye_en.mp3", "opposition_en.mp3", "welcome_en.mp3", "guanzhao_en.mp3"};
    private final static String[] face_zh = {"Angry.mp3", "arrogant.mp3", "cry.mp3", "excited.mp3", "fright.mp3", "grievance.mp3", "Happy.mp3", "Kawayi.mp3", "laugh.mp3", "sad.mp3", "wrath.mp3", "tricky.mp3"};
    private final static String[] face_en = {"Angry.mp3", "arrogant_en.mp3", "cry_en.mp3", "excited_en.mp3", "fright_en.mp3", "grievance_en.mp3", "Happy.mp3", "Kawayi_en.mp3", "laugh_en.mp3", "sad_en.mp3", "wrath_en.mp3", "tricky_en.mp3"};
    private final static String[] action_zh = {"cold.mp3", "cute.mp3", "favor.mp3", "hug_coquetry.mp3", "yawn.mp3", "jiayou.mp3", "sleep.mp3", "Leisure.mp3", "guiguisuisui.mp3"};
    private final static String[] action_en = {"cold_en.mp3", "cute_en.mp3", "favor_en.mp3", "hug_coquetry.mp3", "yawn_en.mp3", "jiayou_en.mp3", "sleep_en.mp3", "Leisure_en.mp3", "guiguisuisui_en.mp3"};
    ...
    public void playMusic(int type, int index, OnCompletionListener listener) {
        String[] hello = !CommonUtils.isEn() ? hello_zh : hello_en;
        String[] face = !CommonUtils.isEn() ? face_zh : face_en;
        String[] action = !CommonUtils.isEn() ? action_zh : action_en;
        // 数据过滤。
        if (type < 0 || index < 0) {
            LogMgr.e("参数解析错误");
            return;
     ...
     * @return 0：无人脸；1有人脸
     */
    public int getFaceTrackedFlag() {
        return faceTrackedFlag;
    }
     ...
     * @return x,y坐标
     */
    public int getFaceTrackedPos(int coor) {
        if (coor == 0) {
            return posX;
        } else {
            return posY;
