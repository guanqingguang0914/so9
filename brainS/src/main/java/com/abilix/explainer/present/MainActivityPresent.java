...
public class MainActivityPresent implements IMainActivityPresent,
    ...
    public MainActivityPresent(IMainActivity mIMainActivity) {
        ...
        if (ControlInfo.getMain_robot_type() == ExplainerInitiator.ROBOT_TYPE_C
                ...
                || ControlInfo.getChild_robot_type() == ExplainerInitiator.ROBOT_TYPE_H3
                || ControlInfo.getChild_robot_type() == ExplainerInitiator.ROBOT_TYPE_H204) {
            //USB摄像头
    ...
    public void doExplainCallBack(ExplainMessage mExplainMessage) {
        ...
        switch (mExplainMessage.getFuciton()) {
                ...
                mIRobotCamera.takePicture(ExplainerApplication.instance, imagePath, new CameraStateCallBack() {
                    ...
                    public void onState(int state) {
                        ...
                        switch (state) {
                            ...
                            case RobotCameraStateCode.TAKE_PICTURE_CAMERA_INIT_ERROR:
                                mHandler.postDelayed(new Runnable() {

                                    @Override
                                    public void run() {
                                        mIMainActivity.dismissAlertDialog(ExplainerAlertDialogs.ALERTDIALOG_CAMERA_OPENING);
            ...
            case ExplainMessage.EXPLAIN_LED:
                ...
                case ExplainMessage.EXPLAIN_CALIBRATE_GYRO:
                    mIMainActivity.showAlertDialog(ExplainerAlertDialogs.ALERTDIALOG_GYRO_CALIBRATION, null);
                    mHandler.postDelayed(new Runnable() {

                        @Override
                        public void run() {
                            mIMainActivity.dismissAlertDialog(ExplainerAlertDialogs.ALERTDIALOG_GYRO_CALIBRATION);
