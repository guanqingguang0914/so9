...
public class ExplainTracker {
    ...
    public static final int MSG_EXPLAIN_CALIBRATE_GYRO = 0x0A;
    ...
    private Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case MSG_EXPLAIN_CALIBRATE_GYRO:  // 0x0A
                    mExplainMessage.setFuciton(ExplainMessage.EXPLAIN_CALIBRATE_GYRO);
                    break;
