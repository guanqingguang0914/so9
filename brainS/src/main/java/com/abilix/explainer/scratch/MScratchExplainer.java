        ...
        do {
            ...
            switch (index) {
                ...
                case 254://closeM(int)
                    ...
                    switch (type) {
                        case 0:// 关闭电机
                            //explainerHelper.SetNeckLRMotor(0);
                            //explainerHelper.SetNeckUPMotor(0);
                            explainerHelper.Mrunstop();
                            explainerHelper.setVacuumPower(0);
                            break;
                        case 1:// 关闭扬声器
                            ...
                            break;
                        case 2:// 关闭LED
                            explainerHelper.setEyeColorMode(0);
                            explainerHelper.Msetled2(0, 3);
                            explainerHelper.Msetled3(0, 3);
                            explainerHelper.Msetled4(0, 3);
                            break;
                        case 3://关闭显示
                            sendExplainMessage(ExplainTracker.MSG_EXPLAIN_NO_DISPLAY);
                            break;
