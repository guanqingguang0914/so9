...
//public class AppInfo extends Mode {
    ...
    public static final long PAGE_ORDER_K9_CUSTOM_FACTORY = -86;
    public static final long PAGE_ORDER_MULTIMEDIA = -85;
    public static final long PAGE_ORDER_SKILLPLAYER = -84;
    public static final long PAGE_ORDER_GROUP = -83;
    public static final long PAGE_ORDER_ACTIVE = -83;
    public static final long PAGE_ORDER_PROTECT = -82;

    //我叫奥科流思2.0
    public static final int PAGE_ORDER_M_FUTURE_SCIENCE = -200;   //未来科学站
    public static final int PAGE_ORDER_M_FUTURE_COOL = -195;   //未来酷乐园
    public static final int PAGE_ORDER_M_FUTURE_COMMUNICATION = -190;  //未来通信站
    public static final int PAGE_ORDER_M_ABILITY_TRAINING = -185;  //能力训练营
    public static final int PAGE_ORDER_M_SKILL = -180;  //技能
    public static final int PAGE_ORDER_M_SET = -175;   //设置
    public static final int PAGE_ORDER_M_AKLS = -197;   //我叫奥科流思
    public static final int PAGE_ORDER_M_QR_CODE = -165;   //二维码
