 ...
 * @author yhd
 */
public class TrainingActivity extends TypefaceBaseActivity {

    private final static int[] InfoName = {R.string.m_training_instruction_learing};
    private final static int[] image = {R.drawable.m_icon_instruction_learning};
