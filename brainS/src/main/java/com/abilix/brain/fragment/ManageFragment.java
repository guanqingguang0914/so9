...
import com.abilix.brain.TypefaceBaseFragmentActivity;
import com.abilix.brain.data.AppInfo;

/**
 * 照片，录音，技能页面。
 */
public class ManageFragment extends TypefaceBaseFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (GlobalConfig.BRAIN_TYPE == GlobalConfig.ROBOT_TYPE_M) {
            setContentView(R.layout.manage_m);
            mBackM = (ImageView) findViewById(R.id.manage_back);
            mTextViewM = (TextView) findViewById(R.id.manage_fragment_textview);
            mBackM.setOnClickListener(new OnClickListener() {
                @Override
