...
public class GlobalConfig {
    ...
    public static final int ROBOT_TYPE_M5S = 0x16;//M图灵子系列，仅用于区分名称和软件升级
    ...
    public static final int ROBOT_TYPE_SO901 = 0x6D; // 图灵 对应的 so901 智能识别
    ...
    public static final int ROBOT_TYPE_C381 = 0x67;
    public static final int ROBOT_TYPE_K204 = 0x68;
    ...
    public static final int ROBOT_TYPE_H204 = 0x6A;
    ...
    public static final int ROBOT_TYPE_S204 = 0x69;
     ...
     * 是否使用H34充电安全机制
     */
    public static final boolean IS_USING_H_CHARGING_PROTECT = true;
...
//    public static final int STM_VISION_C = 33685561;
    ...
    public static final int STM_VISION_M = 16908359;
    ...
    /* APP固件升级 控制命令 */
    public static final byte BRAIN_UPGRADE_IN_CMD_1 = (byte) 0x00;
    public static final byte BRAIN_UPGRADE_IN_CMD_2_QUERY_VERSIONS = (byte) 0x0A;
    public static final byte BRAIN_UPGRADE_IN_CMD_2_INSTALL_APKS = (byte) 0x0B;

    public static final byte BRAIN_UPGRADE_OUT_CMD_1 = (byte) 0xA0;
    public static final byte BRAIN_UPGRADE_OUT_CMD_2_QUERY_VERSIONS_OK = (byte) 0x0A;
    ...
    public static final byte APP_STORE_IN_CMD_2_FACE_TRACK = (byte) 0x04;
    ...
    public static final byte APP_STORE_OUT_CMD_2_FACE_TRACK = (byte) 0x05;
    /* 心跳包命令字 */
    ...
    public static final byte KNOW_ROBOT_SN_OUT_CMD_2 = (byte) 0x14;
...
//    public static final byte KNOW_ROBOT_CAMERA_OUT_CMD_2 = (byte) 0x03;
    ...
    public static final String APP_PACKAGE_NAME_CONTROL = "com.abilix.control";
...
//    com.abilix.learn.oculus.distributorservice.activity.LearnOrderActivity
    ...
    public static final String APP_PKGNAME_OCULUS_ORDER = "com.abilix.learn.oculusorder";   //指令学习
    public static final String APP_PKGNAME_INSTANT_MESSAGING = "com.abilix.easemob";   //即时通信
...
//	public static final String APP_PKGNAME_KNOWTHEROBOT = "com.abilix.knowtherobot";
    ...
    private static final int FUNCTION_C_204 = 3;
    private static final int FUNCTION_H3_H4 = 1;
    private static final int FUNCTION_M3S_M4S = 1;
    private static final int FUNCTION_B204 = 1;
    private static final int FUNCTION_H204 = 2;
    private static final int FUNCTION_M5S = 2;
        ...
        switch (Utils.getProductSerial(ROBOT_BUILD_TYPE)) {
            case "C":
                if (Utils.getCoreVersionNumber(ROBOT_BUILD_TYPE) == CORE_MTK6580) {
                    ...
                    } else if (Utils.getFunctionVersionNumber(ROBOT_BUILD_TYPE) == FUNCTION_C_204) {
                        //表示目前用于C项目C204项目
                        BRAIN_TYPE = ROBOT_TYPE_C;
                        BRAIN_CHILD_TYPE = ROBOT_TYPE_K204;
            ...
            case "M":
                if (Utils.getCoreVersionNumber(ROBOT_BUILD_TYPE) == CORE_MTK6580) {
                    ...
                    } else if (Utils.getFunctionVersionNumber(ROBOT_BUILD_TYPE) == FUNCTION_M5S) {
                        //BRAIN_CHILD_TYPE = ROBOT_TYPE_M5S;
                    }
                } else if (Utils.getCoreVersionNumber(ROBOT_BUILD_TYPE) == CORE_RK3128) {
                    //rk3128平台
            ...
            case "H":
                ...
                } else if(Utils.getFunctionVersionNumber(ROBOT_BUILD_TYPE) == FUNCTION_H204){
                    BRAIN_TYPE = ROBOT_TYPE_H3;
                    BRAIN_CHILD_TYPE = ROBOT_TYPE_H204;
                }else {
            ...
            case "F":
                ...
                break;
            case "S":
                if (Utils.getFunctionVersionNumber(ROBOT_BUILD_TYPE) == FUNCTION_B204) {
                    //表示目前用于S项目平衡车（205）项目
                    BRAIN_CHILD_TYPE = ROBOT_TYPE_S204;
//                    LogMgr.d("BRAIN_CHILD_TYPE = " + ROBOT_TYPE_S204);
                }
